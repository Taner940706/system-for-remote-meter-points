...
ROOT_URLCONF = 'system_for_remote_meter_points.urls'
...
WSGI_APPLICATION = 'system_for_remote_meter_points.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'system_for_remote_meter_points_db',
        'USER': 'postgres-user',
        'PASSWORD': 'password',
        'HOST': '127.0.0.1',
        'PORT': '5432',
